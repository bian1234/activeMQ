 ...
 */
@Component
public class QueueConsumerListener2 {
     ...
     * @return:
     */
    @JmsListener(destination = "${spring.activemq.queue-name2}", containerFactory = "queueListener")
    public void readActiveQueue(String message) {
        System.out.println("queue2-1接受到：" + message);
    }


    @JmsListener(destination = "${spring.activemq.queue-name2}", containerFactory = "queueListener")
    public void readActiveQueue2(String message) {
        System.out.println("queue2-2接受到：" + message);
    }
}
